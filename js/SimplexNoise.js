...
function seed_height(noise, t, x, z){
	...
	return value *t.k +t.b +seed_error(noise, t.e, SEED_RANDOM_CONSTANT[3], x, z);
}
...
function seed_scale(noise, t, x, z){
	let value = noise.more3D(SEED_RANDOM_CONSTANT[5], x/t.q, z/t.q, 6) *t.k +t.b+
		seed_error(noise, t.e, SEED_RANDOM_CONSTANT[6], x, z);
	return value<0?0: value>1?1: value;
}
function seed_treeHeight(noise, t, x, z){
	let result = [0];
	...
	if (t.plt.min < value && value < t.plt.max) // 1/12
		result[3] = noise.more3D(SEED_RANDOM_CONSTANT[8], x/t.q, (z+1)/t.q, 6) *t.k +t.b+
			seed_error(noise, t.e, SEED_RANDOM_CONSTANT[9], x, (z+1));
